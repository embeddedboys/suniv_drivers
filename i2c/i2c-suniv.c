...
static void suniv_i2c_send_start(struct suniv_i2c_data *i2c_data)
{
    ...
    i2c_data->cntr_bits = SUNIV_I2C_REG_CONTROL_BUS_EN | SUNIV_I2C_REG_CONTROL_A_ACK | SUNIV_I2C_REG_CONTROL_INT_EN;
    printk("%s, i2c_data->cntr_bits : 0x%x\n", __func__, i2c_data->cntr_bits);

    if (i2c_data->msgs->flags & I2C_M_RD)
	...
	suniv_i2c_write(i2c_data, i2c_data->reg_offsets.cntr, i2c_data->cntr_bits | SUNIV_I2C_REG_CONTROL_M_STA);
}
...
static irqreturn_t suniv_i2c_isr(int irq, void *dev_id)
{
	...
	while (status_cntr = suniv_i2c_read(i2c_data, i2c_data->reg_offsets.cntr) & 
        ...
        case SUNIV_I2C_BUS_STATUS_MASTER_DATA_ACK: /* 0x28 */
            printk("SUNIV_I2C_BUS_STATUS_ADDR_WR_ACK\n");
            if (i2c_data->byte_left == 0) {
                suniv_i2c_write(i2c_data, i2c_data->reg_offsets.cntr, i2c_data->cntr_bits | SUNIV_I2C_REG_CONTROL_M_STP);
            } else {
...
static int suniv_i2c_probe(struct platform_device *pdev)
{
    ...
    printk("%s:reset the i2c adapter\n", __func__);
